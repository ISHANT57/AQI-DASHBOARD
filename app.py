...
@app.route('/compare')
def compare_page():
    return send_from_directory('static/html', 'compare.html')

@app.route('/trends')
def trends():
    return send_from_directory('static/html', 'trends.html')
...
def export_data():
    return send_from_directory('static/html', 'export_data.html')
